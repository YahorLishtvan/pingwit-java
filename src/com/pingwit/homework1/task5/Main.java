package com.pingwit.homework1.task5;

public class Main { // старайся для классов придумывать названия, согласно таске, например TwoNumbersSum, это хороший способ постепенно привыкать в хорошему именованию
